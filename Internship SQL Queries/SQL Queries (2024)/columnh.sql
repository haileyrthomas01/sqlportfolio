...
GROUP BY Poles_with_One_Attachment.ORG_ID, Attachments_With_Pole_Table_Link."Attachment Type"
HAVING (((Poles_with_One_Attachment.ORG_ID) Is Not Null) AND ((Attachments_With_Pole_Table_Link."Attachment Type")='CTV'))
ORDER BY Count(Poles_with_One_Attachment.CountOfAttach_OBJ_ObjectID) desc;
